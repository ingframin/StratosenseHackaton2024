...
class multiplereceivers(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "multiplereceivers")
        ...
        self.carrier_freq = carrier_freq = 1090e6
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, 320)
...
def main(top_block_cls=multiplereceivers, options=None):
