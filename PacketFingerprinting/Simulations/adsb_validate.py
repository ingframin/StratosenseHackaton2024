...
def main(output_shape, i):
    ...
    filepath= f'../Results/ADSB_Validation/ADSB_{output_shape}/'

    ## Dataset 
    ds=mlf.DataHandler.DataHandlerMatthiasEvaluate('../Dataset/Validation/',input_shape=input_shape,batchsize=2048)
