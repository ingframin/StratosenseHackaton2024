...
def main(output_shape, file_base='../Results/EWSN/', model_name='ResNet', task=0, input_size=64):
    ...
    ## Dataset
    ds=mlf.DataHandler.DataHandlerEWSN_Disjunct2('../Dataset/EWSN_disjunct/',input_shape=input_shape,batchsize=64, uid='ds2')
...
if __name__ == "__main__":
    ...
    for isize in inputs:
        for size in sizes:
            ...
            main(output_shape=size,model_name='ResNet', task=a.task, file_base=fn, input_size=isize)
